				...
				<div className='about__inner'>
					<div className='about__column about__column--left'>
						...
						<div className='about__paragraph-container'>
							...
							<p className='about__paragraph'>
								I haven't always been interested in software. My career background has actually been rooted in support
								and hardware. To me, it seemed like a path for the intellectually gifted and I never thought of myself
								the type.
							</p>
							<p className='about__paragraph'>
								While working as a hardware guy and as time passed, I was gradually exposed to the software side of
								things. I quickly found development to be much more fulfilling so I started a new chapter in my life.
