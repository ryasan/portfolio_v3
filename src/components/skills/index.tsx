            ...
            <div className='skills__column skills__column--right'>
              ...
              <div className='skills__text-container'>
                <p className='skills__paragraph'>
                  My primary skills fall mostly under the frontend spectrum of the tech variety.
                  However, I have experience in all areas of the stack and don't mind getting my
                  hands dirty whether it be frontend, backend, or anything in between.
                </p>
                <p className='skills__paragraph'>
