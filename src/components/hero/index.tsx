          ...
          <div className='hero__inner'>
            ...
            <div className='hero__column hero__column--right'>
              <div className='hero__text-container'>
                <span className='hero__title hero__title--1' ref={refA}></span>
                <span className='hero__title hero__title--2' ref={refB}></span>
                <span className='hero__title-ampersand'>&</span>
                <h4 className='hero__subtitle'>I'm a frontend developer.</h4>
              </div>
              <button className='hero__btn' onClick={() => handlePageClick(sections.length - 1)}>
                CONTACT
              </button>
            </div>
          </div>
